...
const testimonials = [
  {
    ...
    company: "LogiTech",
    content:
      "Thanks to your team, we’ve automated key business processes. Order processing time has nearly been cut in half, and errors have been reduced to a minimum.",
    categories: [1, 3, 5],
  },
  {
    ...
    name: "Inna T.",
    company: "Aurora Event",
    content:
      "The development of our website and mobile app was fast and seamless. The interface is modern and intuitive — our clients are pleased!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Travelix",
    content:
      "We were looking for mobile solutions for travelers, including offline maps and booking. What we received exceeded our expectations.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "CRM integrations and report automation were implemented quickly and efficiently. The team took the time to understand our business and offered well-thought-out solutions.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "EkoMarket",
    content:
      "The team built an online store with intuitive UX and automated logistics. Our sales went up, and customer support became more streamlined.",
    categories: [1, 3],
  },
  {
    ...
    name: "Igor B.",
    company: "Binance Local",
    content:
      "They delivered the website and client portal in only a couple of weeks. Fully customized for our needs—no off‑the‑shelf templates. Clients loved it.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "A minimalist interface, fast loading speed, and a simple structure — the website truly became an effective tool.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "I’m not familiar with technology, but it’s very intuitive to use. An excellent tool, especially for small businesses like mine.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
           We provide innovative solutions that help leaders create healthier and more comfortable work environments — from anywhere in the world.
          </p>
        </div>
